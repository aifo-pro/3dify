            ...
            <div class="relative overflow-hidden rounded-3xl border border-emerald-400/25 bg-zinc-950/90 p-8 shadow-2xl shadow-emerald-950/30 ring-1 ring-white/10 sm:p-10 lg:p-12">
                ...
                <div class="relative">
                    ...
                    <div class="mt-6 flex flex-wrap items-center gap-2 sm:gap-3">
                        <span class="text-[10px] font-bold uppercase tracking-wider text-zinc-500">{{ __('blog.share') }}</span>
                        <a href="https://twitter.com/intent/tweet?url={{ urlencode($canonicalUrl) }}&text={{ urlencode($post->localized_title) }}" target="_blank" rel="noopener" class="inline-flex items-center gap-1.5 rounded-xl border border-white/10 bg-white/[0.05] px-3 py-1.5 text-xs font-bold text-zinc-300 transition hover:border-zinc-400/40 hover:bg-white/10 hover:text-white">
                        ...
                        <a href="https://www.facebook.com/sharer/sharer.php?u={{ urlencode($canonicalUrl) }}" target="_blank" rel="noopener" class="inline-flex items-center gap-1.5 rounded-xl border border-white/10 bg-white/[0.05] px-3 py-1.5 text-xs font-bold text-zinc-300 transition hover:border-blue-400/40 hover:bg-blue-400/10 hover:text-blue-200">
                        ...
                        <button type="button"
                            onclick="navigator.clipboard.writeText('{{ $canonicalUrl }}').then(() => { this.textContent = '✓ Copied!'; setTimeout(() => this.textContent = '{{ __('blog.copy_link') }}', 2000) })"
                            class="inline-flex items-center gap-1.5 rounded-xl border border-white/10 bg-white/[0.05] px-3 py-1.5 text-xs font-bold text-zinc-300 transition hover:border-emerald-400/40 hover:bg-emerald-400/10 hover:text-emerald-200">
