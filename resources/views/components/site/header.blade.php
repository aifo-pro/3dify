                ...
                <div x-show="moreOpen" @click.outside="moreOpen = false" x-cloak
                    ...
                    <div class="py-1.5">
                        <a href="{{ route('makes.gallery') }}" class="flex items-center gap-3 px-4 py-2.5 text-sm text-zinc-200 transition hover:bg-white/[0.06] hover:text-white">
                            <span class="text-base">📸</span> {{ __('Галерея друків') }}
                        </a>
                        <a href="{{ route('challenges.index') }}" class="flex items-center gap-3 px-4 py-2.5 text-sm text-zinc-200 transition hover:bg-white/[0.06] hover:text-white">
                            <span class="text-base">🏆</span> {{ __('Челенджі') }}
                        </a>
                        <a href="{{ route('leaderboard') }}" class="flex items-center gap-3 px-4 py-2.5 text-sm text-zinc-200 transition hover:bg-white/[0.06] hover:text-white">
                            <span class="text-base">🏅</span> {{ __('Рейтинг авторів') }}
                        </a>
                        <a href="{{ route('search') }}" class="flex items-center gap-3 px-4 py-2.5 text-sm text-zinc-200 transition hover:bg-white/[0.06] hover:text-white">
                            <span class="text-base">🔍</span> {{ __('Глобальний пошук') }}
                        </a>
                        <a href="{{ route('compare') }}" class="flex items-center gap-3 px-4 py-2.5 text-sm text-zinc-200 transition hover:bg-white/[0.06] hover:text-white">
                            <span class="text-base">⚖️</span> {{ __('Порівняти моделі') }}
                        </a>
                    </div>
                </div>
            </div>
    ...
    <div x-cloak x-show="open"
        ...
        <nav class="grid gap-1">
            ...
            <div class="my-2 border-t border-white/[0.06] pt-2">
                ...
                <a href="{{ route('makes.gallery') }}" class="rounded-xl px-4 py-2.5 text-sm text-zinc-300 transition hover:bg-white/[0.06] hover:text-white flex items-center gap-2">📸 {{ __('Галерея друків') }}</a>
                <a href="{{ route('challenges.index') }}" class="rounded-xl px-4 py-2.5 text-sm text-zinc-300 transition hover:bg-white/[0.06] hover:text-white flex items-center gap-2">🏆 {{ __('Челенджі') }}</a>
                <a href="{{ route('leaderboard') }}" class="rounded-xl px-4 py-2.5 text-sm text-zinc-300 transition hover:bg-white/[0.06] hover:text-white flex items-center gap-2">🏅 {{ __('Рейтинг авторів') }}</a>
                <a href="{{ route('compare') }}" class="rounded-xl px-4 py-2.5 text-sm text-zinc-300 transition hover:bg-white/[0.06] hover:text-white flex items-center gap-2">⚖️ {{ __('Порівняти') }}</a>
            </div>
